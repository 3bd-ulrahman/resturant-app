<x-dashboard.app-layout>
  ...
  <form action="{{ route('dashboard.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-6">
      ...
      <x-text-input id="name" class="block mt-1 w-full focus:ring-0" type="text" name="name" :value="$category->name"
    ...
    <div class="mb-6">
      ...
      <textarea rows="4" name="description"
        ...
        placeholder="Your message...">{{ $category->description }}</textarea>
