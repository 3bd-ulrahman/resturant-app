<x-dashboard.app-layout>
  ...
  <form action="{{ route('dashboard.tables.update', $table->id) }}" method="POST" enctype="multipart/form-data"
    autocomplete="off">
    @csrf
    @method('PUT')
    ...
    <div class="mb-6">
      ...
      <input
        ...
        name="name" value="{{ $table->name }}" id="name" type="text" required autofocus />
    ...
    <div class="mb-6">
      ...
      <input
        class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full dark:focus:ring-0"
        name="guest_number" value="{{ $table->guest_number }}" id="guest_number" type="text" required />
    ...
    <div class="mb-6">
      ...
      <select name="status" id="location"
